...
export default function VideoCreateForm() {
    ...
    const handleSubmit = (event) => {
        ...
        let createVideoUrl = timApiBaseURL+"service/service/create"
        let createVideoDataUrl = timApiBaseURL+"service/service-data-test/create"
        ...
        // let videoData = {"id":"response.data.id","service":fileData,"fileType":"mp4","size":file.size}
